...
%
% Vectorized. Send vectors of equal length. Will fail with mystery error
...
%
% Also: This function is probably OK for Antarctica, but you should
% consider using antatm.m instead. 
%
% Finally: it is often better to estimate the average pressure at your 
...
% 
% Modified by Nat Lifton -- Purdue University to use ERA-40 instead of 
% NCEP, and also to use a variable lapse rate. 
% March 2011
%
% Greg Balco checked Dec 2014. 
%
...
% data load - load ERA40.mat from the same directory as this file
thisDir = fileparts(mfilename('fullpath'));
load(fullfile(thisDir,'ERA40.mat'));
